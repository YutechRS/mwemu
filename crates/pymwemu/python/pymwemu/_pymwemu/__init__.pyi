...
class Emu:
    ...
    def sizeof_wide(self, unicode_str_ptr: builtins.int) -> builtins.int:
        ...
        """
    def write_string(self, to: builtins.int, from: builtins.str) -> None:
        r"""
        write string on memory.
        """
    def write_wide_string(self, to: builtins.int, from: builtins.str) -> None:
        r"""
        write a wide string on memory.
        """
    def write_buffer(self, to: builtins.int, from: typing.Sequence[builtins.int]) -> None:
        r"""
        write a python list of int bytes to the emulator memory.
        """
    def read_buffer(self, from: builtins.int, sz: builtins.int) -> builtins.list[builtins.int]:
        r"""
        read a buffer from the emulator memory to a python list of int bytes.
        """
    def write_bytes(self, to: builtins.int, from: typing.Sequence[builtins.int]) -> None:
        r"""
        write a python list of int bytes to the emulator memory.
        """
...
def init32() -> Emu:
    r"""
    Initialize a 32-bit emulator instance.
    """

def init64() -> Emu:
    r"""
    Initialize a 64-bit emulator instance.
    """
